...
mySVG.addEventListener("load", function() {
    ...
    var stationPositions = [0, 0.0295, 0.055, 0.208, 0.4237, 0.499, 0.6837, 0.915, 1];
    var pathId = "path9845"
...
function addStations(svgDoc, pathId, stationPositions) {
  ...
  for (var i = 0; i < stationPositions.length; i++) {
    ...
    station.setAttribute("fill", "yellow");
...
eventSource.onmessage = function(event) {
  ...
  setTrainMarkers(svgDoc, "path9823_joined", data[2].positions1, data[2].positions2, r3stationPositions, "yellow", "orange");
  setTrainMarkers(svgDoc, "path9845", data[5].positions1, data[5].positions2, r8stationPositions, "yellow", "orange");
