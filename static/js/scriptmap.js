...
eventSource.onmessage = function(event) {
  ...
  const pathDict = {
    "Rodalies R1": {
        "path": "path9386",
        "stationPositions": [0.000, 0.0280, 0.0480, 0.0680, 
          0.0850, 0.1040, 0.1210, 0.1410, 
          0.1660, 0.1910, 0.2140, 0.2390, 
          0.2630, 0.2880, 0.3120, 0.3370, 
          0.3610, 0.3850, 0.4110, 0.4360, 
          0.4610, 0.4870, 0.6710, 0.7700, 
          0.8070, 0.8650, 1.000]
    },
    "Rodalies R2 Nord": {
        "path": "path9390",
    ...
    "Rodalies R3": {
        ...
        "stationPositions": [1, 0.9815, 0.9451, 0.9268, 0.9085, 0.8903, 0.872, 0.8355, 0.809, 0.791, 0.7727, 0.7543, 0.731, 0.7165, 0.6985, 0.653, 0.630, 0.608, 0.585, 0.5621, 0.539, 0.4782, 0.4475, 0.4000, 0.3845, 0.3593, 0.3445, 0.2985, 0.278, 0.256, 0.2345, 0.16, 0.1335, 0.0935, 0]
    ...
    "Rodalies R7": {
      "path": "path9845-4",
      "stationPositions": [1.000, 0.8920, 0.8490, 0.8050, 
        0.6860, 0.6500, 0.6130, 0.5750, 
        0.4520, 0.4050, 0.3360, 0.1730, 
        0.1310, 0.0900, 0.0450, 0.000]
    },
    "Rodalies R8": {
      "path": "path9845",
